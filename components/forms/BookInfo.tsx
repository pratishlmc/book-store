	...
	return (
		<>
			...
			<SimpleGrid columns={[1, 2]} spacing={"10px"}>
				<FormControl mr="5%">
					<FormLabel fontWeight={"normal"}>Book's Name</FormLabel>
					<Input
				...
				<FormControl>
					<FormLabel fontWeight={"normal"}>Genre</FormLabel>
					<Select
						value={formData.genre}
						onChange={(e) =>
							setFormData({ ...formData, genre: e.target.value, grade: "", publication: "" })
						}
					>
